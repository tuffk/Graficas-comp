...
GLMmodel *wall, *piso, *pmodel4, *pmodel5, *pmodel6; /* the loaded model */
GLuint modeWall, modePiso, mode, mode2, mode3, mode4, mode5, mode6; /* viewing mode */
...
void loadFinalWalls(void);
void loadFinalRoom(void);
void room(void);

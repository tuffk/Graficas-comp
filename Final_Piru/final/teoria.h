...
class Teoria{
	public:
		...
		void respuestas(){
				...
				cout << "   Red: lo mas a la izquierda \n   Green: casi en medio\n   Blue: lo mas a la dereca \n   Black: justo en medio y lo mas abajo\n   White: justo en el centro y lo mas arriba" << endl;
				...
				cout << "     linea 2: se define una variable que no va a cambiar en ningun momento que se llame a dibujar, tambien es usado para los vertex_shaders" << endl;
				cout << "     linea 3: Asigna los vertex_shaders a la posision actual del vertex" << endl;

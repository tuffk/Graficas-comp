...
void dedo(float posicion)
{
   glPushMatrix();
      glTranslatef( 0.7, 0.0, posicion );
      glRotatef ( (GLfloat) dedos, 0.0, 0.0, 1.0);
      glTranslatef( 0.5, 0.0, 0.0 );
      glPushMatrix(); // dedo
         glScalef (1.0, 0.2, 0.15);
         glutWireCube (1.0);
      glPopMatrix();
...
void mano()
{
   glPushMatrix();
      ...
      glRotatef ( (GLfloat) muneca, 0.0, 0.0, 1.0);
...
void brazo(float valor)
{
   glPushMatrix();
      glTranslatef (0.0, 0.0, valor);

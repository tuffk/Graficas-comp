...
void loadWallFloor() {
  ...
  modePiso =
      glmList(piso, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);
}
...
void loadAlice() {
  ...
  mode2 =
      glmList(pmodel2, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel3 = glmReadOBJ("files/tetrapak.obj");
  glmUnitize(pmodel3);
  glmVertexNormals(pmodel3, 90.0, GL_TRUE);
  mode3 =
      glmList(pmodel3, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel4 = glmReadOBJ("files/fancyFrontDoor.obj");
  glmUnitize(pmodel4);
  glmVertexNormals(pmodel4, 90.0, GL_TRUE);
  mode4 =
      glmList(pmodel4, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel5 = glmReadOBJ("files/tableBasseVerre.obj");
  glmUnitize(pmodel5);
  glmVertexNormals(pmodel5, 90.0, GL_TRUE);
  mode5 =
      glmList(pmodel5, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel6 = glmReadOBJ("files/beerGlass.obj");
  glmUnitize(pmodel6);
  glmVertexNormals(pmodel6, 90.0, GL_TRUE);
  mode6 =
      glmList(pmodel6, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);
}
...
void loadHeartQueen() {
  ...
  mode13 =
      glmList(pmodel13, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel14 = glmReadOBJ("files/cardGame.obj");
  glmUnitize(pmodel14);
  glmVertexNormals(pmodel14, 90.0, GL_TRUE);
  mode14 =
      glmList(pmodel14, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel15 = glmReadOBJ("files/sword2a.obj");
  glmUnitize(pmodel15);
  glmVertexNormals(pmodel15, 90.0, GL_TRUE);
  mode15 =
      glmList(pmodel15, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel16 = glmReadOBJ("files/chessboard.obj");
  glmUnitize(pmodel16);
  glmVertexNormals(pmodel16, 90.0, GL_TRUE);
  mode16 =
      glmList(pmodel16, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel17 = glmReadOBJ("files/Heart.obj");
  glmUnitize(pmodel17);
  glmVertexNormals(pmodel17, 90.0, GL_TRUE);
  mode17 =
      glmList(pmodel17, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);
}
...
void loadPrincessRoom() {
  ...
  glmVertexNormals(pmodel13, 90.0, GL_TRUE);
  mode18 =
      glmList(pmodel18, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);
  ...
  mode20 =
      glmList(pmodel20, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel21 = glmReadOBJ("files/derouleurWC.obj");
  glmUnitize(pmodel21);
  glmVertexNormals(pmodel21, 90.0, GL_TRUE);
  mode21 =
      glmList(pmodel21, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);

  pmodel22 = glmReadOBJ("files/bath_L.obj");
  glmUnitize(pmodel22);
  glmVertexNormals(pmodel22, 90.0, GL_TRUE);
  mode22 =
      glmList(pmodel22, GLM_SMOOTH | GLM_2_SIDED | GLM_MATERIAL | GLM_TEXTURE);
}
...
void Reshape(int w, int h) {
  ...
  gluPerspective(fovy, (double)w / (double)h, _zNear,
                 -20); /* PErspective for stereo */
...
/* HelpRenderBitmapString(30,linestart+=linespace,(void *)Help_Font, "L/l =
